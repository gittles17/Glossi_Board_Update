...
- VISUAL: Short text (1-2 sentences, under 200 chars) paired with an infographic. The visual carries the argument. The text sets it up. The infographic will be auto-generated by AI based on the tweet text.
- LINK: 1-2 sentence hook that teases the linked content. Not "check out our latest post." More "We wrote about why X matters." The user will attach the URL separately.
